...
class ModalFormUser extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (prevProps.LoginReducer.user !== LoginReducer.user) {
            this.setState({ user: LoginReducer.user.data[0] });
            console.log(LoginReducer.user, "LOGINREDUCER DESDE EL MODALFORM");
        } else if (prevProps.LoginReducer.allUsers !== LoginReducer.allUsers) {
            this.props.userGet();
        }
    }
    handleReset() {
                ...
                >
                    ...
                    <FontIcon className="material-icons" style={iconStyles}>
                        ...
                        <TextField
                            style={textStyles}
                            onChange={this.handleChange}
                            value={this.state.user.country_id || ""}
                            name="country_id"
                            hintText="Pais"
                        />
                    </FontIcon>
                    ...
                    <FontIcon className="material-icons" style={iconStyles}>
                        ...
                        >
                            ...
                            {/*Traer el value de un servicio de api*/}
...
export default connect(
    mapToStateToProps,
    { closeModal, userGet, addUser, editUser, showModal }
)(ModalFormUser);
